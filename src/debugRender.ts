...
class Media {
    static continueSvg: string = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200"><defs><style>.start-1{fill:#399d0b;}.start-2{fill:#93ca7a;}</style></defs><g id="Ebene_2" data-name="Ebene 2"><g id="Ebene_1-2" data-name="Ebene 1"><rect class="start-1" width="30" height="200" rx="15"/><path class="start-2" d="M62.13,137.59h105a0,0,0,0,1,0,0v30a0,0,0,0,1,0,0h-105a15,15,0,0,1-15-15v0A15,15,0,0,1,62.13,137.59Z" transform="translate(-76.52 120.44) rotate(-45)"/><path class="start-1" d="M57.43,42.43h120a15,15,0,0,1,15,15v15a0,0,0,0,1,0,0h-135a15,15,0,0,1-15-15v0A15,15,0,0,1,57.43,42.43Z" transform="translate(75 -66.21) rotate(45)"/></g></g></svg>`;
    static startSvg: string = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200"><defs><style>.start-1{fill:#399d0b;}.start-2{fill:#93ca7a;}</style></defs><g id="Ebene_2" data-name="Ebene 2"><g id="Ebene_1-2" data-name="Ebene 1"><path class="start-2" d="M62.13,137.59h105a0,0,0,0,1,0,0v30a0,0,0,0,1,0,0h-105a15,15,0,0,1-15-15v0A15,15,0,0,1,62.13,137.59Z" transform="translate(-76.52 120.44) rotate(-45)"/><path class="start-1" d="M57.43,42.43h120a15,15,0,0,1,15,15v15a0,0,0,0,1,0,0h-135a15,15,0,0,1-15-15v0A15,15,0,0,1,57.43,42.43Z" transform="translate(75 -66.21) rotate(45)"/></g></g></svg>`;
    static stepOverSvg: string = `<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" viewBox="0 -75 215 215"><defs><style>.step-1{fill:#9cb5de;}.step-2{fill:#0071bc;}</style></defs><g id="Ebene_2" data-name="Ebene 2"><g id="Ebene_1-2" data-name="Ebene 1"><path class="step-1" d="M4.39,55.13a15,15,0,0,0,20,1.07,120,120,0,0,1,159.71,9l21.21-21.22A150,150,0,0,0,5.69,32.75,15,15,0,0,0,4.38,55.13Z"/><path class="step-2" d="M214,52.47,188,7.52a10,10,0,0,0-17.32,0L144.75,52.44a10,10,0,0,0,8.66,15l51.91,0A10,10,0,0,0,214,52.47Z"/><circle class="step-2" cx="99.25" cy="83" r="25"/></g></g></svg>`;
    static restartSvg: string = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200"><defs><style>.restart-1{fill:#93ca7a;}.restart-2{fill:#399d0b;}</style></defs><g id="Ebene_2" data-name="Ebene 2"><g id="Ebene_1-2" data-name="Ebene 1"><path class="restart-1" d="M89.22,20.27v27c35.61,0,64.38,29,63.53,64.43-.8,33.36-28.28,60.57-62,61.36A63.41,63.41,0,0,1,27,122.84a13.58,13.58,0,0,0-13.36-10.76h0A13.52,13.52,0,0,0,.28,128.23C8.74,169.19,45.34,200,89.22,200c50.19,0,91.09-40.75,90.78-90.44C179.69,60.19,139.16,20.27,89.22,20.27Z"/><path class="restart-2" d="M89.22,20.27v27c35.09,0,63.55,28.16,63.55,62.91a62.41,62.41,0,0,1-18.62,44.48l19.26,19.06A89.12,89.12,0,0,0,180,110.14C180,60.5,139.36,20.27,89.22,20.27Z"/><path class="restart-2" d="M37,44.61,82,70.54a10,10,0,0,0,15-8.67V10A10,10,0,0,0,82,1.35L37,27.28A10,10,0,0,0,37,44.61Z"/></g></g></svg>`;
    static stopSvg: string = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200"><defs><style>.cls-1{fill:#ca0707;}.cls-2{fill:#c38383;}</style></defs><g id="Ebene_2" data-name="Ebene 2"><g id="Ebene_1-2" data-name="Ebene 1"><path class="cls-1" d="M15,0H185a15,15,0,0,1,15,15V30a0,0,0,0,1,0,0H0a0,0,0,0,1,0,0V15A15,15,0,0,1,15,0Z"/><path class="cls-1" d="M100,85H270a15,15,0,0,1,15,15v15a0,0,0,0,1,0,0H85a0,0,0,0,1,0,0V100A15,15,0,0,1,100,85Z" transform="translate(285 -85) rotate(90)"/><path class="cls-2" d="M0,15V185a15,15,0,0,0,15,15H30V30L4.39,4.39A15,15,0,0,0,0,15Z"/><path class="cls-2" d="M170,170H0v15a15,15,0,0,0,15,15H185a15,15,0,0,0,10.61-4.39Z"/></g></g></svg>`;
    static rightArrow: string = `<svg id="Ebene_1" data-name="Ebene 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 9.15 16" width="7" style="padding-right: 12px; padding-top: 2px;"><defs><style>.c-1{fill:white;}</style></defs><path class="c-1" d="M8.82,8.76,2,15.67a1.12,1.12,0,0,1-1.59,0,1.11,1.11,0,0,1,0-1.58L6.44,8,.33,1.92A1.12,1.12,0,0,1,.33.33a1.11,1.11,0,0,1,1.58,0l6.9,6.85A1.16,1.16,0,0,1,9.15,8a1.11,1.11,0,0,1-.33.79" transform="translate(0 0)"/></svg>`;
    static downArrow: string = `<svg id="Ebene_1" data-name="Ebene 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 9.15" width="12.24" style="padding-right: 7px;"><defs><style>.c-2{fill:white;}</style></defs><path class="c-2" d="M7.24,8.82.33,2A1.12,1.12,0,0,1,.33.38a1.11,1.11,0,0,1,1.58,0L8,6.44,14.08.33a1.12,1.12,0,0,1,1.59,0,1.11,1.11,0,0,1,0,1.58L8.82,8.81A1.16,1.16,0,0,1,8,9.15a1.11,1.11,0,0,1-.79-.33"/></svg>`;
}
...
export class Renderer {
    ...
    private buildStyle(template: IStyle, override: boolean = false, ...style: IStyle[]): string {
        let styles = {};
        if (!override) {
            styles = template;
        }
    ...
    renderWrapper(style: IStyle = {}, override: boolean = false) {
        const wrapper = document.createElement("div");
        wrapper.setAttribute("style", this.buildStyle(Styles.wrapper, override, style));
        return wrapper;
    }

    renderButton(content: string, action: keyof IButtonEvents, style: IStyle, disabled: boolean = false, override: boolean = false) {
